            ...
            <div class="row">
                <div class="col-lg-7 col-sm-6">
                    ...
                    <div class="breadcrumb">
                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>">Trang Chủ</a> / Tin Tức
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-7 col-sm-12 col-md-8">
                	<?php if($loop->have_posts()) : ?>
                		<?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
                			<?php $url = wp_get_attachment_image_url(get_field('news_image', $loop->ID), "full" ); ?>
                			<div class="blogbox wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
		                        <div class="blogimg"><img src="<?php echo $url ? resizeImage($url, 714, 500) : dummyImage(664, 465); ?>" class="img-responsive img-center">
		                        </div>
                                    ...
                                    <?php while ( $loop_collection->have_posts() ) : $loop_collection->the_post(); ?>
                                        ...
                                        <div class="postdiv wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                                            <a href="<?php echo get_permalink($loop_collection->ID); ?>">
                                                <h5><?php the_title(); ?></h5>
                                                <div class="rightpostimg"><img src="<?php echo $url ? resizeImage($url, 420, 300) : dummyImage(420, 300); ?>" class="img-responsive img-center">
                                                </div>
                                            </a>
                                        </div>
                                    <?php endwhile; ?>
                                <?php else: ?>
                                    <div class="blogbox wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;"> Không có bộ sưu tập nào!
                                    </div>
                                <?php endif ?>
                            </div>
                        </div>
