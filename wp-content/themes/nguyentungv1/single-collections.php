            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    ...
                    <div class="breadcrumb">
                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>">Trang Chủ</a> / <a href="<?php echo esc_url( home_url( '/' ) ); ?>bo-suu-tap">Bộ sưu tập</a> / <?php echo the_title(); ?>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <?php if(have_posts()) : while(have_posts()) : the_post(); ?>
                        <?php 
                            $url = wp_get_attachment_image_url( get_field('collection_image', get_the_ID()), "full" );
                        ?>
